...
import { Permission } from "node-mirai-sdk/types/src/typedef";
const {
  Image,
...
export class dailyPaper implements base {
  ...
  sendInTimer() {
    ...
    //   [
    //     Image({
    //       url: path.resolve(process.cwd(), "./node-core/statics/img/out/paper.png")
    //     })
    //   ],
    //   this.qqGroup
    // );
    
    this.bot.instance.sendImageMessage("node-core/statics/img/out/paper.png",{ type: 'GroupMessage', sender: { group:  { id: this.qqGroup} } }
    );
  }
}
